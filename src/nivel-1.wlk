...
object nivel1 {
    method init() {
        ...
        game.onCollideDo(silvestre, {alguien => game.say(alguien, "¡PERDÍ!") alguien.energia(0) game.onTick(2000, "mori", {self.init() })})
        game.onCollideDo(nido,      {alguien => game.say(alguien, "¡GANE!")  alguien.energia(1000) game.onTick(2000, "gane", {self.init() })})
